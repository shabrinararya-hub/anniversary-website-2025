...
const CONFIG = {
    ...
    // You can use emojis! 💝 💖 💗 💓 💞 💕
    pageTitle: "Happy Anniversary Sayaaaang💝",
    ...
    questions: {
        ...
        third: {
            text: "Owyaaaah, if so, then can you promise me to still be around til the next oneeee?", // The big question!
            yesBtn: "Yes!",                                             // Text for "Yes" button
            noBtn: "No"                                                 // Text for "No" button
        }
    },
    ...
    music: {
        ...
        musicUrl: "https://res.cloudinary.com/dgeb2mudq/video/upload/v1771487437/Wave_to_Earth_-_Seasons__mp3.pm_h3wyh2.mp3", // Music streaming URL
